...
const FeaturedPostCard = ({ post }) => (
  <div className="featuredPostCard relative h-72">
    <div
      className="featuredPostCard_inner absolute inline-block h-72 w-full rounded-lg bg-cover bg-center bg-no-repeat shadow-md"
